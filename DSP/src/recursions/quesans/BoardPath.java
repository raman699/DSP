...
//		System.out.println(count);
		...
		getBoardSnP(0, 9, snl, moves, 0);
		printBoardPathWithSnlAndMoves(0,9,snl,moves,0);
	...
	public static void getBoardSnP(int src, int des, int snl[], int moves[], int midx)
	{
		...
		if (src == 0)
		{
			...
			{
				getBoardSnP(src + 1, des, snl, moves, midx + 1);
			} else
	...
	public static void printBoardPathWithSnlAndMoves(int src, int des, int snl[], int moves[], int mvidx)
	{
		...
		if(src==0)
		{
			...
			{
				printBoardPathWithSnlAndMoves(src+1, des, snl, moves, mvidx+1);
			}
			else
			{
				printBoardPathWithSnlAndMoves(src, des, snl, moves, mvidx+1);
			}
		}
		else
		{
			if(snl[src]!=0)
			{
				printBoardPathWithSnlAndMoves(snl[src], des, snl, moves, mvidx);
			}
			else if(src +moves[mvidx] <= des)
			{
				printBoardPathWithSnlAndMoves(src +moves[mvidx], des, snl, moves, mvidx+1);
			}
			else
			{
				printBoardPathWithSnlAndMoves(src, des, snl, moves, mvidx+1);
